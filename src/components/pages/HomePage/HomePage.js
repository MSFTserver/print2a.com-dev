          ...
          <div className="homePageBox">
            ...
            <div className="homePageContents">
              ...
              <p>
                ...
                <br></br>
                <Link href="http://donate.print2a.com/"><Words style={{ textShadow: '0 0 4px rgba(215, 24, 24, 0.65)' }} animate layer='alert' show={this.props.anim.entered}>
              ...
              <p>
                <Words layer="header" animate show={this.props.anim.entered}>
                  BTC Address:</Words>
                <br></br>
                <Words style={{ textShadow: '0 0 4px rgba(215, 24, 24, 0.65)' }} animate layer='alert' show={this.props.anim.entered}>
